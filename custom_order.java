...
public class custom_order {
    ...
    double tax; // Amount of tax --> TAX_RATE * total cost

    // Introduce shop and prompt user to input first name
    System.out.println("Welcom to Java's Cake & Cupcake Shop!");
    System.out.println("We make custom cakes witho our secret cake batter!");
